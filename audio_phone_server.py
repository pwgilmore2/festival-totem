...
.audioMeters{gap:9px;margin:14px 0 3px}.audioMeter{padding:9px 7px;background:linear-gradient(180deg,#292538,#171924);border:1px solid #ffffff1b}.audioBar{height:106px;border:1px solid #ffffff18;border-radius:9px;background:linear-gradient(0deg,#151522,#0b0b11)}.audioBar:after{content:"";position:absolute;inset:0;pointer-events:none;background:repeating-linear-gradient(to top,transparent 0 13px,#0b0b18b0 13px 16px);border-radius:8px}.audioFill{background:linear-gradient(to top,#6949df,#c678ef);box-shadow:0 0 18px #9562f688;transition:height .09s ease-out}.audioMeter:nth-child(2) .audioFill{background:linear-gradient(to top,#c63875,#ff9b61);box-shadow:0 0 18px #f16a8788}.audioMeter:nth-child(3) .audioFill{background:linear-gradient(to top,#257eae,#58d9d1);box-shadow:0 0 18px #5edacf88}.audioMeter:nth-child(4) .audioFill{background:linear-gradient(to top,#749642,#dbda64);box-shadow:0 0 18px #dfd86688}.audioLabel{font-size:11px;font-weight:800;letter-spacing:.03em;opacity:.94;text-transform:uppercase}.pulseRow{display:flex;align-items:center;gap:10px;margin:11px 2px 4px;color:#ffcde0;font-size:11px;font-weight:800;letter-spacing:.09em}.pulseRow .pulseLamp{flex:1;margin:0;height:11px;background:#342333}.pulseRow .pulseLamp.on{background:linear-gradient(90deg,#ff5a9d,#ffbe72);box-shadow:0 0 18px #ff5a9dcc}
...
<div class="pulseRow"><span>PULSE</span><div id="beatLamp" class="pulseLamp"></div></div>

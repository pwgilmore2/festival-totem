...
@media(max-width:520px){.simpleAudioGrid{grid-template-columns:1fr}.presetGrid{grid-template-columns:repeat(2,1fr)}.signalReadout{grid-template-columns:repeat(2,1fr)}}
</style>
"""

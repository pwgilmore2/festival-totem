...
.chaosFxGrid{display:grid;grid-template-columns:repeat(2,1fr);gap:10px}.chaosFxGrid button{min-height:112px;font-size:18px;touch-action:none;-webkit-user-select:none;user-select:none}.chaosFxGrid button.pressed{transform:scale(.96);filter:brightness(1.3)}
...
.fxPixelMelt{background:linear-gradient(145deg,#ff4d00,#7a001f)}.fxJumble{background:linear-gradient(145deg,#ffd000,#ff4d00);color:#160d00!important}.fxBass{background:linear-gradient(145deg,#4318ff,#ff185f)}.fxTrance{background:linear-gradient(145deg,#004e92,#00c9a7)}.fxLiquid{background:linear-gradient(145deg,#00b4d8,#7209b7)}.fxTunnel{background:linear-gradient(145deg,#001d3d,#ff006e)}

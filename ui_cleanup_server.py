...
input[type=range]{height:46px;margin:2px 0;padding:0;background:transparent;touch-action:none;-webkit-tap-highlight-color:transparent}
...
function toggleTextBgSlideshow(){textBgSlideshowLocal=!textBgSlideshowLocal;syncTextBgSlideshow();textChanged()}

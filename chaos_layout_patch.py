...
_CSS = r'''
<style>
.chaosCard{padding:10px 20px 16px}.chaosFxGrid,.xyWrap{margin-left:5px;margin-right:5px}
...
<div class="sectionHint">Hold briefly to play an effect. Scroll along the edges or swipe through the buttons; drag the pad to blend effects.</div>
...
<button class="fxChaos" onpointerdown="safeHoldStart(event,'chaos')" onpointermove="safeHoldMove(event)" onpointerup="safeHoldEnd(event)" onpointercancel="safeHoldEnd(event)" onlostpointercapture="safeHoldEnd(event)">💀<br>CHAOS</button>
<button class="fxGlitch" onpointerdown="safeHoldStart(event,'glitch')" onpointermove="safeHoldMove(event)" onpointerup="safeHoldEnd(event)" onpointercancel="safeHoldEnd(event)" onlostpointercapture="safeHoldEnd(event)">⚡<br>GLITCH</button>
<button class="fxJumble" onpointerdown="safeHoldStart(event,'jumble')" onpointermove="safeHoldMove(event)" onpointerup="safeHoldEnd(event)" onpointercancel="safeHoldEnd(event)" onlostpointercapture="safeHoldEnd(event)">🧩<br>JUMBLE</button>
<button class="fxPixelMelt" onpointerdown="safeHoldStart(event,'pixelmelt')" onpointermove="safeHoldMove(event)" onpointerup="safeHoldEnd(event)" onpointercancel="safeHoldEnd(event)" onlostpointercapture="safeHoldEnd(event)">🔥<br>PIXEL MELT → NEXT</button>
<button class="fxMelt" onpointerdown="safeHoldStart(event,'meltdown')" onpointermove="safeHoldMove(event)" onpointerup="safeHoldEnd(event)" onpointercancel="safeHoldEnd(event)" onlostpointercapture="safeHoldEnd(event)">🫠<br>MELT / REBUILD</button>
</div></div>
...
<button class="fxTrance" onpointerdown="safeHoldStart(event,'trance')" onpointermove="safeHoldMove(event)" onpointerup="safeHoldEnd(event)" onpointercancel="safeHoldEnd(event)" onlostpointercapture="safeHoldEnd(event)">🌊<br>TRANCE</button>
<button class="fxLiquid" onpointerdown="safeHoldStart(event,'liquid')" onpointermove="safeHoldMove(event)" onpointerup="safeHoldEnd(event)" onpointercancel="safeHoldEnd(event)" onlostpointercapture="safeHoldEnd(event)">💧<br>LIQUID</button>
<button class="fxRainbow" onpointerdown="safeHoldStart(event,'rainbow')" onpointermove="safeHoldMove(event)" onpointerup="safeHoldEnd(event)" onpointercancel="safeHoldEnd(event)" onlostpointercapture="safeHoldEnd(event)">🌈<br>RAINBOW</button>
<button class="fxPrism" onpointerdown="safeHoldStart(event,'prism')" onpointermove="safeHoldMove(event)" onpointerup="safeHoldEnd(event)" onpointercancel="safeHoldEnd(event)" onlostpointercapture="safeHoldEnd(event)">🔮<br>PRISM</button>
<button class="fxWarp" onpointerdown="safeHoldStart(event,'warp')" onpointermove="safeHoldMove(event)" onpointerup="safeHoldEnd(event)" onpointercancel="safeHoldEnd(event)" onlostpointercapture="safeHoldEnd(event)">🌀<br>WARP</button>
<button class="fxTunnel" onpointerdown="safeHoldStart(event,'tunnel')" onpointermove="safeHoldMove(event)" onpointerup="safeHoldEnd(event)" onpointercancel="safeHoldEnd(event)" onlostpointercapture="safeHoldEnd(event)">🕳️<br>TUNNEL</button>
</div></div>
...
function safeHoldStart(e,kind){
  ...
  safeHold={id:e.pointerId,el,x:e.clientX,y:e.clientY,fired:false,oneShot:kind==='pixelmelt',timer:null};
...
function safeHoldEnd(e){
  if(!safeHold||safeHold.id!==e.pointerId)return;
  clearTimeout(safeHold.timer);
  safeHold.el.classList.remove('holdPending','pressed');
  const fired=safeHold.fired,oneShot=safeHold.oneShot;
  safeHold=null;

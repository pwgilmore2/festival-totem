...
<div class="textGrid">
<div class="slider"><div class="sh"><span>Size</span><span id="textScaleValue">1x</span></div><input id="textScale" type="range" min="1" max="3" step="1" value="1" oninput="textScaleValue.textContent=this.value+'x';textChanged()"></div>
<div class="slider"><div class="sh"><span>Speed</span><span id="textSpeedValue">12</span></div><input id="textSpeed" type="range" min="1" max="40" step="1" value="12" oninput="textSpeedValue.textContent=this.value;textChanged()"></div>
</div>
...
<div class="sectionHint" style="margin-top:10px">Rainbow cycles each character. Audio color follows the current music bands. Beat Pulse works whenever phone audio is running.</div>
</div></section>
"""
...
GUEST_SECTION = r"""
<section id="guest" class="view"><div class="card chaosCard"><h2 class="chaosTitle">CHAOS PAD</h2><div class="chaosSub">Smash buttons. Hold chaos. Saved setup stays untouched.</div>
...
let layerSignature='',sceneSignature='',textTimer=null,textFxLocal={glow:false,wave:false,glitch:false,beat_pulse:true};
...
function textPayload(){return {message:textMessage.value,font:textFont.value,motion:textMotion.value,color_mode:textColorMode.value,color:textColor.value,scale:parseInt(textScale.value),speed:parseFloat(textSpeed.value),...textFxLocal}}
